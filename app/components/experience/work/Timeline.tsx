    ...
    <group position={point.point} scale={isMobile ? 0.35 : 0.6}>
      ...
      <group>
        <group position={getPoint}>
          <Text {...textProps} fontSize={0.22} anchorY="bottom" position={[-diff / 2, 0.4, 0]}>
            {point.year}
          </Text>
          <group position={[0, 0, 0]}>
            <Text {...titleProps} fontSize={0.35} anchorY="middle" maxWidth={3.5} position={[0, 0.1 - diff / 2, 0]}>
              {point.title}
            </Text>
            <Text {...textProps} fontSize={0.14} anchorY="top" maxWidth={3.5} lineHeight={1.3} position={[0, -0.15 - diff, 0]}>
              {point.subtitle}
            </Text>
          </group>
        </group>
